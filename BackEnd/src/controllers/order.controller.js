...
export const getMyOrders = async (req, res) => {
  try {
    ...
    const data = await orderService.getMyOrders(req.user.userId, { page, limit, skip });
...
export const getOrderDetail = async (req, res) => {
  try {
    const data = await orderService.getOrderDetail(req.params.orderId, req.user.userId);
