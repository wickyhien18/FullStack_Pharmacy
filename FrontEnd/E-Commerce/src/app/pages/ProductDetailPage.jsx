  ...
  const mockReviews = [
    {
      ...
      date: "10/06/2026",
      comment:
        "S\u1EA3n ph\u1EA9m r\u1EA5t t\u1ED1t, u\u1ED1ng th\u1EA5y s\u1EE9c \u0111\u1EC1 kh\xE1ng t\u0103ng r\xF5 r\u1EC7t. Giao h\xE0ng nhanh, \u0111\xF3ng g\xF3i c\u1EA9n th\u1EADn.",
      verified: true,
    },
    {
      name: "Tr\u1EA7n V\u0103n B",
      ...
      date: "08/06/2026",
      comment:
        "H\xE0ng ch\xEDnh h\xE3ng, gi\xE1 t\u1ED1t. S\u1EBD mua l\u1EA1i l\u1EA7n sau.",
      verified: true,
    },
    {
      name: "L\xEA Th\u1ECB C",
      ...
      date: "05/06/2026",
      comment:
        "D\xF9ng \u0111\u01B0\u1EE3c 1 th\xE1ng th\u1EA5y da d\u1EBB t\u01B0\u01A1i s\xE1ng h\u01A1n, ng\u1EE7 ngon h\u01A1n. R\u1EA5t h\xE0i l\xF2ng!",
      verified: true,
    },
  ];
  return (
        ...
        <div>
          ...
          <div className="bg-blue-50 rounded-xl p-4 mb-4">
            <div className="flex items-end gap-3 mb-1">
              ...
              {product.discount && (
                <span
                  className="text-white text-sm font-bold px-2 py-0.5 rounded-lg mb-1"
                  style={{ backgroundColor: "#e53935" }}
                >
                  -{product.discount}%
                </span>
          ...
          {/* <div className="space-y-2.5">
            {[
              {
                icon: <Shield size={16} />,
                text: "S\u1EA3n ph\u1EA9m ch\xEDnh h\xE3ng 100%",
              },
              {
                icon: <Truck size={16} />,
                text: "Giao h\xE0ng nhanh 2H n\u1ED9i th\xE0nh",
              },
              {
                icon: <Phone size={16} />,
                text: "H\u1ED7 tr\u1EE3 24/7: 1800 6928",
              },
            ].map((item) => (
              <div
                key={item.text}
            ...
            <div className="space-y-4">
              {/* <div className="flex items-center gap-4 mb-6 p-4 bg-gray-50 rounded-xl">
                <div className="text-center">
                  <div
                    className="font-bold"
                    style={{ fontSize: "2.5rem", color: "#1250dc" }}
                  >
                    {product.rating}
                  </div>
