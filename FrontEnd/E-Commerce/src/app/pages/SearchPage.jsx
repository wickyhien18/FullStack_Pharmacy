...
function SearchPage() {
  ...
  const matchedProducts = useMemo(() => {
    ...
    return products.filter(
      (p) => p.name.toLowerCase().includes(lower) || p.brand.toLowerCase().includes(lower) || p.tags.some((t) => t.toLowerCase().includes(lower)) || p.description.toLowerCase().includes(lower)
    );
  }, [q]);
