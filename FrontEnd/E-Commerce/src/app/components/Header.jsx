...
const navLinks = [
  { label: "Thu\u1ED1c", href: "/products?category=medicines" },
  { label: "TPCN", href: "/products?category=functional-foods" },
  { label: "L\xE0m \u0111\u1EB9p", href: "/products?category=cosmetics" },
  { label: "Ch\u0103m s\xF3c c\xE1 nh\xE2n", href: "/products?category=personal-care" },
  { label: "Thi\u1EBFt b\u1ECB y t\u1EBF", href: "/products?category=medical-devices" },
  { label: "M\u1EB9 & B\xE9", href: "/products?category=mother-baby" },
  { label: "Khuy\u1EBFn m\xE3i", href: "/promotions", highlight: true },
