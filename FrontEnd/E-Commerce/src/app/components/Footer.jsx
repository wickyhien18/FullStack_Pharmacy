...
import { Phone, Mail, MapPin, Facebook, Youtube, Instagram, Shield, Award, Clock, Truck } from "lucide-react";
function Footer() {
    ...
    /* Brand */
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <div>
                <div style={{ color: "#1250dc" }} className="font-bold text-lg">Long Châu</div>
                <div className="text-xs text-gray-500">Nhà thuốc FPT</div>
              </div>
            </Link>
            <p className="text-sm text-gray-600 mb-4 leading-relaxed">
              Hệ thống nhà thuốc Long Châu với hơn 3.200 nhà thuốc trên toàn quốc. Cam kết cung cấp thuốc chính hãng, giá tốt nhất.
            </p>
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div className="flex items-start gap-2">
                <MapPin size={14} style={{ color: "#1250dc" }} className="mt-0.5 shrink-0" />
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              <a href="#" className="w-9 h-9 bg-pink-600 rounded-full flex items-center justify-center text-white hover:bg-pink-700 transition-colors">
                <Instagram size={16} />
              </a>
            </div>
          </div>
    ...
    /* Quick links */
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Gi\u1EDBi thi\u1EC7u", "H\u1EC7 th\u1ED1ng nh\xE0 thu\u1ED1c", "Tuy\u1EC3n d\u1EE5ng", "Tin t\u1EE9c", "Li\xEAn h\u1EC7"].map((item) => <li key={item}>
                  <a href="#" className="text-sm text-gray-600 hover:text-blue-700 transition-colors">{item}</a>
                </li>)}
            </ul>
          </div>
    ...
    /* Bottom bar */
      ...
      <div className="border-t border-gray-100 py-4 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-gray-500">
          <span>© 2026 Công ty Cổ phần Dược phẩm Long Châu (FPT Retail). Tất cả quyền được bảo lưu.</span>
