              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {post.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs px-2.5 py-1 bg-gray-100 rounded-full text-gray-600 hover:bg-blue-100 hover:text-blue-700 cursor-pointer transition-colors"
                    >
                      #{tag}
                    </span>
                  ))}
        ...
        <aside className="space-y-5">
              ...
              {related.map((r) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-gray-800 group-hover:text-blue-700 transition-colors line-clamp-2">
                      {r.title}
                    </div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <Link
                  key={tag}
                  to={`/blog?q=${tag}`}
                  className="text-xs px-2.5 py-1.5 bg-gray-100 rounded-full text-gray-600 hover:bg-blue-100 hover:text-blue-700 transition-colors"
                >
                  #{tag}
                </Link>
              ))}
          ...
          >
            ...
            <p className="text-sm text-white/80 mb-4">
              Gặp dược sĩ chuyên nghiệp để được tư vấn trực tiếp về sức khỏe của
              bạn.
            </p>
            <a
              href="tel:18006928"
              className="block text-center bg-white py-2.5 rounded-xl text-sm font-semibold hover:bg-blue-50 transition-colors"
              style={{ color: "#1250dc" }}
            >
...
export { BlogDetailPage as default };
