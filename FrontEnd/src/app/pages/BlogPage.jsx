  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-5">
      ...
      <Link
        ...
        className="group relative rounded-2xl overflow-hidden mb-8 block"
        style={{ height: "340px" }}
      >
        <img
          src={featured.image}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8">
          ...
          <h2
            className="text-white font-bold mb-2 group-hover:text-blue-200 transition-colors"
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
          {allCategories.map((cat) => (
            <button
              ...
              style={
                activeCategory === cat ? { backgroundColor: "#1250dc" } : {}
              }
            >
              {cat}
            </button>
        ...
        {filtered.slice(1).map((post) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              <h3
                className="font-semibold text-gray-800 mb-2 leading-snug group-hover:text-blue-700 transition-colors"
