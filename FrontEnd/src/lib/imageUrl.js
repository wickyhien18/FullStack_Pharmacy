...
export const productDetailMain = (url) =>
  getOptimizedImageUrl(url, { width: 800, quality: 85 });
export const productDetailThumb = (url) =>
  getOptimizedImageUrl(url, { width: 160, quality: 70 });
export const adminTableImage = (url) =>
  getOptimizedImageUrl(url, { width: 400, quality: 70 });
